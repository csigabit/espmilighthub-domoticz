...
<plugin key="MilightESP8266" name="ESP8266 Milight Hub" version="0.0.9">
    ...
    <params>
        ...
        <param field="Mode2" label="mqtt_topic_pattern" width="300px" default="milight/:device_id"/>
...
# =============================================================DEVICE CONFIG==============================================================
    ...
    def setLightDevice(self, device_id, device_type, group_id, message):
        ...
        if len(matchingDevices) == 0:
            ...
            Name = str(device_id)
            if TypeName != '' and Name != '__unnamed_group' and Name != '':
                self.makeDevice(Name, Options, TypeName, switchTypeDomoticz, message)
                matchingDevices = self.getDevices(device_id, device_type, group_id)
            elif Type != 0 and Name != '__unnamed_group' and Name != '':
